  ...
  constructor() {
    this.reset.push(
      new FilterMode(
        "NoFilter",
        "None Filter",
        "Display page without any filters applied",
    ...
    this.achromato.push(
      new FilterMode(
        "Achromatomaly",
        "Achromatomaly",
        "Lacking most color vision (reduced color blind)",
    ...
    this.achromato.push(
      new FilterMode(
        "Achromatopsia",
        "Achromatopsia",
        "Lacking all color vision (no color blind)",
    ...
    this.prot.push(
      new FilterMode(
        "Protanopia",
        "Protanopia",
        "Red-green colour blindness (red appears dark)",
    ...
    this.deuter.push(
      new FilterMode(
        "Deuteranomaly",
        "Deuteranomaly",
        "Lightly red-green hue discrimination",
    ...
    this.deuter.push(
      new FilterMode(
        "Deuteranopia",
        "Deuteranopia",
        "Moderate red-green hue discrimination",
    ...
    this.tritan.push(
      new FilterMode(
        "Tritanomaly",
        "Tritanomaly",
        "Low blue-yellow hue discrimination",
