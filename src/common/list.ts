    ...
    categories.forEach((category) => {
      ...
      category.modes.forEach((mode) => {
        ...
        if (category.type === "segmented") {
          ...
          btn.textContent = mode.name.replace(" Filter", "").replace(
            " Colours",
            "",
          );
          ...
          btn.onclick = (ev) => {
            category.container?.querySelectorAll("button").forEach((b) =>
          ...
          item.onclick = (ev) => {
            ...
            category.container?.querySelectorAll(".list-item").forEach((i) =>
