...
var FiltersUIList = (function () {
    function FiltersUIList(listContainer, clickCallback) {
        var _this = this;
...
var AchromaJS = (function () {
    ...
    AchromaJS.prototype.isEnabled = function () {
        if (!window.localStorage) {
            return false;
        }
        var query = new URL(document.location.href).searchParams.get('achromajs');
    ...
    AchromaJS.prototype.init = function () {
        ...
        new FiltersUIList(wrapper, this.filterClicked);
    ...
    AchromaJS.prototype.filterClicked = function (ev) {
        console.log(ev);
    };
    return AchromaJS;
}());
document.addEventListener('DOMContentLoaded', function () {
    var ajs = new AchromaJS();
    if (ajs.isEnabled()) {
        ajs.init();
    }
});
